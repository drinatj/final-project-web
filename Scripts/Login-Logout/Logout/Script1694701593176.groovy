...
WebUI.click(findTestObject('My Account/btn_profile'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementVisible(findTestObject('My Account/label_My account'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementVisible(findTestObject('My Account/label_My orders'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementVisible(findTestObject('My Account/label_Sign out'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('My Account/label_Sign out'), FailureHandling.STOP_ON_FAILURE)
